...
train_transform = transforms.Compose([
    ...
    transforms.RandomAffine(
        degrees=5,
        #translate=(0.05, 0.05) # translate is not necessary since data in the existing dataset is already not centered
    ),  # You can delete the "#" beside translate=(0.05, 0.05) to make the code valid
...
# Training loop ---------------------------------------------------------------
    ...
    for epoch in range(epoch+1, epochs+1):
        print("Processing Training Epoch " + str(epoch) + "/" + str(TRAINING_CYCLES) + "...")
